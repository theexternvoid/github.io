...
function get_template_A_base_str(user_info)
{
  ...
  str += (is_valid_data(user_info.blog_link) ? '<a href="' + user_info.blog_link + '">My blog</a> | ' : '') + (is_valid_data(user_info.linkedin_link) ? '<a href="' + user_info.linkedin_link + '">LinkedIn profile</a> | ' : '') + '<a href="' + user_info.follow_reseach_link + '">Follow my latest research</a><br/>';
  str += '<br/>';
